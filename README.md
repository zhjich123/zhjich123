...
- 🌐 界面风格支持中/英/日/韩多语言
- 🔖 版本号升级为 v1.0.2，脚本文件重命名为 `media-sniffer-v1.0.2.user.js`

### v1.0.1 (2026-07-17)
- 🔧 修复自动更新功能：更新检查目标改为当前仓库 `zhjich123/zhjich123`
- 🔧 修复翻译功能：翻译请求改用 `GM_xmlhttpRequest`，绕过浏览器 CORS 限制
- 🔧 增强 MyMemory 翻译引擎的错误提示（免费额度耗尽、语言对错误等）
- 🔖 版本号升级为 v1.0.1，脚本文件重命名为 `media-sniffer-v1.0.1.user.js`
