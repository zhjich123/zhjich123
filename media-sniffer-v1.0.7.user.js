// ==UserScript==
// @name         媒体嗅探器 Media Sniffer Pro v1.0.8
...
(function () {
    ...
    try {
    console.info('[MS] 脚本开始加载，版本:', '1.0.8');
    ...
    LANG.strings = {
        ...
        ,
            ...
            'cookie': 'Cookie:',
            'infoLine1': '媒体嗅探器 Pro v1.0.8 · SelectionManager · 拖拽排序 · 收藏夹 · 智能去重 · 分组 · 批量操作注册 · 插件系统',
        ...
        ,
            ...
            'userAgent': 'User-Agent:',
            'cookie': 'Cookie:',
            'infoLine1': 'Media Sniffer Pro v1.0.8 · SelectionManager · Drag Sort · Favorites · Smart Dedup · Groups · Batch Actions · Plugin System',
        ...
        ,
            ...
            'userAgent': 'User-Agent:',
            'cookie': 'Cookie:',
            'infoLine1': 'メディアスニッファー Pro v1.0.8 · モジュール設計 · AES-128復号 · 仮想リスト · 進捗可視化 · プラグインシステム',
        ...
        ,
            ...
            'userAgent': 'User-Agent:',
            'cookie': 'Cookie:',
            'infoLine1': '미디어 스니퍼 Pro v1.0.8 · 모듈 구조 · AES-128 복호화 · 가상 리스트 · 진행률 · 플러그인 시스템',
